...
for file in *.*; do
    ...
    echo '{
            ...
            "threshold": '"$threshold"',
            "lra": '"$lra"',
            "centroid_1": '"$left_centroid"',
            "centroid_2": '"$right_centroid"',
            "variance_1": '"$left_variance"',
            "variance_2": '"$right_variance"',
            "spread_1": '"$left_spread"',
            "spread_2": '"$right_spread"',
            "skewness_1": '"$left_skewness"',
            "skewness_2": '"$right_skewness"',
            "kurtosis_1": '"$left_kurtosis"',
            "kurtosis_2": '"$right_kurtosis"',
            "entropy_1": '"$left_entropy"',
            "entropy_2": '"$right_entropy"',
            "flatness_1": '"$left_flatness"',
            "flatness_2": '"$right_flatness"',
            "crest_1": '"$left_crest"',
            "crest_2": '"$right_crest"',
            "flux_1": '"$left_flux"',
            "flux_2": '"$right_flux"',
            "slope_1": '"$left_slope"',
            "slope_2": '"$right_slope"',
            "decrease_1": '"$left_decrease"',
            "decrease_2": '"$right_decrease"',
            "rolloff_1": '"$left_rolloff"',
            "rolloff_2": '"$right_rolloff"',
